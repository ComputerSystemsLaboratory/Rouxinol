...
from rouxinol.transformer import CFGgrindCFGCompactVisitor


class CFGgrindCFGCompactGraph(Transformer):
    """Extract a code representations.

    - CFGGrind CFG Compact Graph
    ...
    def __init__(
        ...
        self.visitor = CFGgrindCFGCompactVisitor
