...
from rouxinol.transformer import ASTDataCFGTokenVisitor


class ASTDataCFGTokenGraph(Transformer):
    ...
    def __init__(
        ...
        self.visitor = ASTDataCFGTokenVisitor
    ...
    def from_src(
        ...
        **kwargs
        ...
        """Extact the ASTDataCFGToken graph.
