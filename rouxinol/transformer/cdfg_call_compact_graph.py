...
class CDFGCallCompactGraph(Transformer):
    ...
    def __init__(self):
        self.visitor = R.LLVMCDFGCallCompactSingleVisitor

        super().__init__()

    def from_src(self, src_filename: str, *args, **kwargs) -> Dict:
        """Extact the CDFG Compact plus call edges graph.
    ...
    def from_ir(self, ir_filename: str, *args, **kwargs) -> Dict:
        """Extact the CDFG Call Compact graph.
