...
usage() {
    echo "Usage: $0 --out-dir <directory> --rouxinol <directory> --dataset <string> [--problems <integer>] [--samples <integer>] [--rounds <integer>] [--game <integer>] [--shuffle] [--no-cc2025]"  
...
OPTIONS=$(getopt -o "" --long out-dir:,rouxinol:,dataset:,problems:,samples:,rounds:,game:,shuffle,no-cc2025 -- "$@")  
if [ $? -ne 0 ]; then  
    usage  
fi  
