...
flags.DEFINE_string('statistics_directory', None, 'The directory where the YAML files are located and where the result will be saved.')  
flags.DEFINE_string('metric', 'acc', 'The name of the metric to load from the YAML files (e.g., "acc", "precision", "f1", "recall").')  
...
flags.DEFINE_string('prefix', 'stats', 'The prefix for the filename.')  
