...
flags.DEFINE_string('output_directory', None, 'Directory where the YAML files are located')  
...
def main(argv):  
	...
	if FLAGS.output_directory is None or FLAGS.representations is None or FLAGS.flags is None or FLAGS.suffix is None:  
