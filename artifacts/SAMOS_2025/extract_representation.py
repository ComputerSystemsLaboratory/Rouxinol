...
flags.DEFINE_string("output_directory", None, "Data directory (representation, stats, ...)")

flags.DEFINE_list("benchmarks", None, "Benchmarks")
flags.DEFINE_list("tasklets", [1, 2, 4, 8 , 16], "Tasklets")
flags.DEFINE_list("dpus", [1, 2, 4, 8 , 16], "DPUs")

flags.DEFINE_boolean("force", False, "Always compile")
flags.DEFINE_boolean("timestamped", False, "Create a timestamped directory (output_directory/date.time.dir)")

flags.DEFINE_enum("representation", "llvmHistogram", ["llvmHistogram", "ir2vec"], "Representation to extract")
