...
def main(argv):
    ...
    vplots = ax.violinplot(
        ...
        showmedians=True, # Shows the median
        showextrema=True  # Shows the min/max
    )
    ...
    """
    # Customize the mean, median, and extrema lines
    vplots['cmeans'].set_edgecolor(line_color)
    vplots['cmeans'].set_linewidth(2)
    vplots['cmedians'].set_edgecolor(line_color)
    vplots['cmedians'].set_linewidth(2)
    vplots['cmins'].set_edgecolor(line_color)
    vplots['cmins'].set_linewidth(1.5)
    vplots['cmaxes'].set_edgecolor(line_color)
    vplots['cmaxes'].set_linewidth(1.5)
    """
