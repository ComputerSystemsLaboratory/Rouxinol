...
from rouxinol.utility import create_timestamped_directory, get_next_filename, create_string, split_train_test_data
...
flags.DEFINE_integer("entry", 0, "Number of the workload")
...
def main(argv):
    ...
    model_transform = {
        ...
        "programl": (GGNNModel, split_train_test_data)
    }
